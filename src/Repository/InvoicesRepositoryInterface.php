...
{
    public function findAll(string $document, DocumentManager $documentManager);
    ...
    public function createInvoice(Invoice $invoice, DocumentManager $documentManager);

    public function updateShoppingCart(array $products, string $document, DocumentManager $documentManager);

    public function payInvoice(Invoice $invoice, DocumentManager $documentManager);
    ...
    public function deleteProductToShoppingCart(string $document, string $idProduct, DocumentManager $documentManager);
}
